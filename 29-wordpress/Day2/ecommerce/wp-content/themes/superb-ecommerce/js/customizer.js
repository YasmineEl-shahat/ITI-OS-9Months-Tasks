...
(function ($) {
  ...
  // Color preview
    wp.customize("sidebar_bgc", function (value) {
    value.bind(function (to) {
      $("#secondary").css({
        background: to,
      });
...
wp.customize("woocommerce_bg_color", function (value) {
    value.bind(function (to) {
      $(".woocommerce-page, .woocommerce-page.archive, .woocommerce-page.single-product, .woocommerce-shop").css({
        background: to,
      });
    });
  });

  wp.customize("navigation_cart_color", function (value) {
    value.bind(function (to) {
      $("a.cart-customlocation svg, a.cart-customlocation svg *").css({
        color: to,
      });
    });
  });
  wp.customize("navigation_cart_color", function (value) {
    value.bind(function (to) {
      $("a.cart-customlocation span.cart-icon-number").css({
        background: to,
      });
    });
  });
  ...
  wp.customize("pagination_bg_color", function (value) {
    value.bind(function (to) {
      $(".page-numbers li .page-numbers, .page-numbers li a").css({
        background: to,
      });
    });
  });
  ...
  wp.customize("pagination_border_color", function (value) {
    value.bind(function (to) {
      $(".page-numbers li .page-numbers").css({
        "border-color": to,
      });
    });
  });
  ...
  wp.customize("pagination_text_color", function (value) {
    value.bind(function (to) {
      $(".page-numbers li .page-numbers, .page-numbers li .page-numbers").css({
        color: to,
      });
    });
  });

  wp.customize("header_img_button_bg_color", function (value) {
    value.bind(function (to) {
      $(".header-button-wrap a").css({
        background: to,
      });
    });
  });
  wp.customize("header_img_button_text_color", function (value) {
    value.bind(function (to) {
      $(".header-button-wrap a").css({
        color: to,
      });
  ...
  wp.customize("blogfeed_bgc", function (value) {
    value.bind(function (to) {
      $("a.read-story").css({
        background: to,
      });
  ...
  wp.customize("blogfeed_readmorebutton", function (value) {
    value.bind(function (to) {
      $("a.read-story").css({
        color: to,
      });
  ...
  wp.customize("header_logo_color", function (value) {
    value.bind(function (to) {
      $(".site-title, logofont, .site-description").css({
        color: to,
      });
    });
  });
  ...
  wp.customize("navigation_border_color", function (value) {
    value.bind(function (to) {
      $(
        "#smobile-menu.show .main-navigation ul ul.children.active, #smobile-menu.show .main-navigation ul ul.sub-menu.active, #smobile-menu.show .main-navigation ul li, .smenu-hide.toggle-mobile-menu.menu-toggle, #smobile-menu.show .main-navigation ul li, .primary-menu ul li ul.children li, .primary-menu ul li ul.sub-menu li"
      ).css({
        "border-color": to,
      });
    });
  ...
  wp.customize("footer_text_color", function (value) {
    value.bind(function (to) {
      $(
        ".site-info, .footer-column-three input.search-submit, .footer-column-three p, .footer-column-three li, .footer-column-three td, .footer-column-three th, .footer-column-three caption"
      ).css({
        color: to,
      });
    });
  ...
  wp.customize("footer_link_color", function (value) {
    value.bind(function (to) {
      $(
        ".site-footer a, .footer-column-three a, .footer-column-three li a, .footer-column-three .widget a, .footer-column-three .sub-arrow"
      ).css({
        color: to,
      });
    });
  ...
  wp.customize("footer_go_to_top", function (value) {
    value.bind(function (to) {
      $("#goTop").css({
        background: to,
      });
  ...
  wp.customize("footer_go_to_top_hover", function (value) {
    value.bind(function (to) {
      $("#goTop:hover").css({
        background: to,
      });
  ...
  wp.customize("blogfeed_byline_color", function (value) {
    value.bind(function (to) {
      $(
        ".all-blog-articles .entry-meta, .all-blog-articles .entry-meta a, .all-blog-articles .blog-data-wrapper, .all-blog-articles .blog-data-wrapper a"
      ).css({
        color: to,
      });
    });
  ...
  wp.customize("postpage_byline_color", function (value) {
    value.bind(function (to) {
      $(
        ".single .entry-meta, .single .entry-meta a, .single .blog-data-wrapper, .single .blog-data-wrapper a, .page .entry-meta, .page .entry-meta a, .page .blog-data-wrapper, .page .blog-data-wrapper a"
      ).css({
        color: to,
      });
    });
  ...
  wp.customize("postpage_buttonbg_color", function (value) {
    value.bind(function (to) {
      $(
        "#main .post-navigation .nav-links .nav-previous, #main .post-navigation .nav-links .nav-next, .related-posts a.read-more, .comments-area p.form-submit input, .nav-next a, .nav-previous a"
      ).css({
        background: to,
      });
    });
  ...
  wp.customize("postpage_border_color", function (value) {
    value.bind(function (to) {
      $(
        ".related-posts-headline h3, .page .comments-area, .page article.fbox, .page article tr, .page .comments-area ol.comment-list ol.children li, .page .comments-area ol.comment-list .comment, .single .comments-area, .single article.fbox, .single article tr, .comments-area ol.comment-list ol.children li, .comments-area ol.comment-list .comment, .error404 main#main, .error404 .search-form label, .search-no-results .search-form label, .error404 input.search-submit, .search-no-results input.search-submit, .error404 main#main, .search-no-results section.fbox.no-results.not-found"
      ).css({
        "border-color": to,
      });
    });
  ...
  wp.customize("postpage_buttontext_color", function (value) {
    value.bind(function (to) {
      $(
        ".related-posts a.read-more, .nav-next a, .nav-previous a, .single .comments-area p.form-submit input, .page .comments-area p.form-submit input"
      ).css({
        color: to,
      });
    });
  ...
  wp.customize("postpage_text_color", function (value) {
    value.bind(function (to) {
      $(
        ".about-the-author-description, .page .content-area p, .page article, .page .content-area table, .page .content-area dd, .page .content-area dt, .page .content-area address, .page .content-area .entry-content, .page .content-area li, .page .content-area ol, .single .content-area p, .single article, .single .content-area table, .single .content-area dd, .single .content-area dt, .single .content-area address, .single .entry-content, .single .content-area li, .single .content-area ol, .search-no-results .page-content p"
      ).css({
        color: to,
      });
    });
  ...
  wp.customize("upperwidgets_text_color", function (value) {
    value.bind(function (to) {
      $(
        ".header-widget, .header-widget p, .header-widget li, .header-widget .textwidget"
      ).css({
        color: to,
      });
    });
  ...
  wp.customize("upperwidgets_title_color", function (value) {
    value.bind(function (to) {
      $(
        ".header-widget .widget-title, .header-widget h1, .header-widget h3, .header-widget h2, .header-widget h4, .header-widget h5, .header-widget h6"
      ).css({
        color: to,
      });
    });
  ...
  wp.customize("upperwidgets_border_color", function (value) {
    value.bind(function (to) {
      $(".header-widgets-three *, .header-widgets-three input").css({
        "border-color": to,
      });
    });
  });
  ...
  wp.customize("navigation_background_color", function (value) {
    value.bind(function (to) {
      $(
        ".primary-menu .pmenu, .super-menu, #smobile-menu, .primary-menu ul li ul.children, .primary-menu ul li ul.sub-menu, .top-nav-wrapper"
      ).css({
        "background-color": to,
      });
    });
  ...
  wp.customize("sidebar_bg_color", function (value) {
    value.bind(function (to) {
      $(
        "#secondary .widget li, #secondary input.search-field, #secondary div#calendar_wrap, #secondary .tagcloud, #secondary .textwidget"
      ).css({
        background: to,
      });
    });
  ...
  wp.customize("postpage_bg_color", function (value) {
    value.bind(function (to) {
      $(
        ".about-the-author, .related-posts, .comments-area, .single article.fbox, .page article.fbox"
      ).css({
        background: to,
      });
    });
  ...
  wp.customize("header_textcolor", function (value) {
    value.bind(function (to) {
      if ("blank" === to) {
        $("logofont, .site-title, .site-description, .logofont").css({
        ...
        $("logofont, .site-title, .site-description").css({
          color: to,
        });
      }
    });
