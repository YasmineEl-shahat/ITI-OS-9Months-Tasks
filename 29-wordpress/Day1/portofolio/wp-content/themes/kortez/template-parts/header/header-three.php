...
<header id="masthead" class="site-header header-three">
	<div class="top-header">
		<?php if( !get_theme_mod( 'disable_top_header_section', false ) ){ ?>
			<?php if( ( !get_theme_mod( 'disable_header_social_links', false ) && kortez_has_social() ) || has_nav_menu( 'menu-3') ){ ?>
		...
		<?php if( !get_theme_mod( 'disable_mobile_top_header', false ) ){ ?>
			<?php if( ( !get_theme_mod( 'disable_header_social_links', false ) && !get_theme_mod( 'disable_mobile_social_icons_header', false ) && kortez_has_social() ) || ( has_nav_menu( 'menu-3') && !get_theme_mod( 'disable_secondary_menu',false) ) || ( !get_theme_mod( 'disable_search_icon', false ) && !get_theme_mod('disable_mobile_search_icon',false) ) || is_active_sidebar( 'menu-sidebar' ) ){ ?>
