				...
				<div class="row">
					<?php
						...
						if( !get_theme_mod( 'disable_sidebar_blog_page', false ) ){
							kortez_left_sidebar( $sidebarColumnClass );
						} ?>
						...
						<?php
							if( !get_theme_mod( 'disable_pagination', false ) ):
								the_posts_pagination( array(
									'next_text' => '<span>'.esc_html__( 'Next', 'kortez' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'kortez' ) . '</span>',
									'prev_text' => '<span>'.esc_html__( 'Prev', 'kortez' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'kortez' ) . '</span>',
									'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'kortez' ) . ' </span>',
								));
							endif;
						?>
					</div><!-- #primary -->
					<?php
						if( !get_theme_mod( 'disable_sidebar_blog_page', false ) ){
							kortez_right_sidebar( $sidebarColumnClass );
						}
					?>
				</div>
		</section>
