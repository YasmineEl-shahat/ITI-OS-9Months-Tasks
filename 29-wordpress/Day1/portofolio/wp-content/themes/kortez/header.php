	...
	<div id="site-preloader">
		<div class="preloader-content">
			<?php
				...
				echo apply_filters( 'kortez_preloader','<img src="'. esc_url( $src ) .'" alt="">' ); //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
			?>
		</div>
	</div>
<?php endif; ?>
...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'kortez' ); ?></a>
