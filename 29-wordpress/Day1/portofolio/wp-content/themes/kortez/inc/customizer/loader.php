...
function kortez_default_styles(){
	...
	$site_primary_color = get_theme_mod( 'site_primary_color', '#DB5362' );
			...
			if( !empty( $header_buttons ) && is_array( $header_buttons ) ){
		    	...
		    	foreach( $header_buttons as $value ){
		    		...
		    		if( $value['header_btn_type'] == 'button-primary' ){
			    		$css .= '
							.site-header .header-btn-'. esc_attr( $i ) .'.button-primary {
								background-color: '. esc_attr( $header_btn_bg_color ) .';
								color: '. esc_attr( $header_btn_text_color ) .';
							}

							.site-header .header-btn-'. esc_attr( $i ) .'.button-primary:hover,
							.site-header .header-btn-'. esc_attr( $i ) .'.button-primary:focus,
							.site-header .header-btn-'. esc_attr( $i ) .'.button-primary:active {
						...
						$css .= '
							...
							.site-header .header-btn-'. esc_attr( $i ) .'.button-outline {
								border-color: '. esc_attr( $header_btn_border_color ) .';
								color: '. esc_attr( $header_btn_text_color ) .';
							}

							.site-header .header-btn-'. esc_attr( $i ) .'.button-outline:hover,
							.site-header .header-btn-'. esc_attr( $i ) .'.button-outline:focus,
							.site-header .header-btn-'. esc_attr( $i ) .'.button-outline:active {
								background-color: '. esc_attr( $header_btn_hover_color ) .';
						...
						$css .= '
							.site-header .header-btn-'. esc_attr( $i ) .'.button-text {
								color: '. esc_attr( $header_btn_text_color ) .';
								padding: 0;
							}
							.site-header .header-btn-'. esc_attr( $i ) .'.button-text:hover,
							.site-header .header-btn-'. esc_attr( $i ) .'.button-text:focus,
							.site-header .header-btn-'. esc_attr( $i ) .'.button-text:active {
			...
			if( !empty( $transparent_header_buttons ) && is_array( $transparent_header_buttons ) ){
		    	...
		    	foreach( $transparent_header_buttons as $value ){
		    		...
		    		if( $value['transparent_header_btn_type'] == 'button-primary' ){
				    		$css .= '
								.header-two.sticky-header .header-btn-'. esc_attr( $i ) .'.button-primary {
						...
						$css .= '
							.header-two.sticky-header .header-btn-'. esc_attr( $i ) .'.button-outline {
						...
						$css .= '
							.header-two.sticky-header .header-btn-'. esc_attr( $i ) .'.button-text {
								color: '. esc_attr( $transparent_header_btn_text_color ) .';
								padding: 0;
							}
						';
		    		...
		    		if( $value['transparent_header_btn_type'] == 'button-primary' ){
			    		$css .= '
							...
							.site-header .header-btn-'. esc_attr( $i ) .'.button-primary:focus,
							.site-header .header-btn-'. esc_attr( $i ) .'.button-primary:active,
							.transparent-header .header-two.sticky-header .header-btn-'. esc_attr( $i ) .'.button-primary:hover,
							.transparent-header .header-two.sticky-header .header-btn-'. esc_attr( $i ) .'.button-primary:focus,
							.transparent-header .header-two.sticky-header .header-btn-'. esc_attr( $i ) .'.button-primary:active {
						...
						$css .= '
							...
							.site-header .header-btn-'. esc_attr( $i ) .'.button-outline:focus,
							.site-header .header-btn-'. esc_attr( $i ) .'.button-outline:active,
							.transparent-header .header-two.sticky-header .header-btn-'. esc_attr( $i ) .'.button-outline:hover,
							.transparent-header .header-two.sticky-header .header-btn-'. esc_attr( $i ) .'.button-outline:focus,
							.transparent-header .header-two.sticky-header .header-btn-'. esc_attr( $i ) .'.button-outline:active {
								background-color: '. esc_attr( $transparent_header_btn_hover_color ) .';
						...
						$css .= '
							...
							.site-header .header-btn-'. esc_attr( $i ) .'.button-text:focus,
							.site-header .header-btn-'. esc_attr( $i ) .'.button-text:active,
							.transparent-header .header-two.sticky-header .header-btn-'. esc_attr( $i ) .'.button-text:hover,
							.transparent-header .header-two.sticky-header .header-btn-'. esc_attr( $i ) .'.button-text:focus,
							.transparent-header .header-two.sticky-header .header-btn-'. esc_attr( $i ) .'.button-text:active {
	...
	$css .= '
		...
		.widget ul li,
		.latest-posts-widget .post {
			border-bottom-color: '. esc_attr( kortez_hex2rgba( $top_footer_widget_link_color, 0.2 ) ).';
		}
	...
	$css .= '
		.site-footer .social-profile ul li a {
			background-color: '. esc_attr( kortez_hex2rgba( $bottom_footer_text_link_color, 0.1 ) ).';
		}
	';
    ...
    $blog_post_category_color = get_theme_mod( 'blog_post_category_color', '#DB5362' );
    $blog_post_meta_color = get_theme_mod( 'blog_post_meta_color', '#7a7a7a' );
    $blog_post_meta_icon_color = get_theme_mod( 'blog_post_meta_icon_color', '#DB5362' );
