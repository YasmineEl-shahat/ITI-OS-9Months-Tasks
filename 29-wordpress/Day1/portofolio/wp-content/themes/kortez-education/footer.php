...
?>
	<?php
		$footer_layout = '';
		if( get_theme_mod( 'footer_layout', 'footer_five' ) == 'footer_one'){
			$footer_layout = 'site-footer-primary';
		}elseif( get_theme_mod( 'footer_layout', 'footer_five' ) == 'footer_two'){
			$footer_layout = 'site-footer-two';
		}elseif( get_theme_mod( 'footer_layout', 'footer_five' ) == 'footer_three'){
			$footer_layout = 'site-footer-three';
		}elseif( get_theme_mod( 'footer_layout', 'footer_five' ) == 'footer_five'){
			$footer_layout = 'site-footer-five';
		}
	...
	<footer id="colophon" class="site-footer <?php echo esc_attr( $footer_layout . ' ' . $has_footer_bg ) ?>">
		<div class="site-footer-inner" style="background-image: url(<?php echo esc_url( $footer_image ) ?>">
			<?php if( !get_theme_mod( 'disable_footer_widget', false ) ):
			 if( kortez_is_active_footer_sidebar() ): ?>
			...
			<?php if( !get_theme_mod( 'disable_bottom_footer', false ) ) { ?>
				<?php if( get_theme_mod( 'footer_layout', 'footer_five' ) == '' || get_theme_mod( 'footer_layout', 'footer_five' ) == 'footer_one' ){
